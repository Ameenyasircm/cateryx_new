...
abstract class $NoteModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String description, int createdTime});
}
...
class _$NoteModelImpl implements _NoteModel {
  ...
  @override
  String toString() {
    return 'NoteModel(id: $id, title: $title, description: $description, createdTime: $createdTime)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, createdTime);
...
abstract class _NoteModel implements NoteModel {
  const factory _NoteModel(
      ...
      required final int createdTime}) = _$NoteModelImpl;
